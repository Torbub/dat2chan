...
if($_FILES["file"]["error"]>0) {
    ...
    echo "cool file, bro!";
    $file_name=MD5($_FILES["file"]["tmp_name"]."_".$id);
    move_uploaded_file($_FILES["file"]["tmp_name"],"/home/2/d/dat2chan/www/img/".$file_name.$ext);
    $File="/home/2/d/dat2chan/www/img/".$file_name;
    thumbcreator::create_thumbnail($File,$ext);
    $File="/home/2/d/dat2chan/www/img/".$file_name.$ext;
    $imgurl="http://www.dat2chan.org/img/".$file_name.$ext;
    $imgurl_thumb="http://www.dat2chan.org/img/".$file_name."_thumb".$ext;
}
